...
**ファイル**: `mcp/src/infra/pluginClient.ts:40-87`
...
**ファイル**: `mcp/src/infra/fallbackStorage.ts:8-66`
...
**ファイル**: `mcp/src/domain/semanticService.ts:44-54`, `mcp/src/tools/semanticSearch.ts:22-28`
