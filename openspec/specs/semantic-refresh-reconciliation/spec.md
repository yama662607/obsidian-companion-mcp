# semantic-refresh-reconciliation Specification

## Purpose
Define how explicit semantic refresh reconciles indexed state with current vault contents and reports that work to clients.
